...
class goods_import(models.Model):
    ...
    @api.one
    @api.depends('invoice_ids.amount_untaxed','currency_rate')
    def _compute_amount(self):
        ...
        for invoice in self.invoice_ids :
            if invoice.type_service == 'purchase_goods' :
                ...
                self.amount_import_charges += invoice.amount_untaxed*invoice.currency_rate
        self.amount_total = self.import_amount + self.amount_import_charges
        ...
        for invoice in self.invoice_ids:
            if invoice.type_service == 'purchase_goods':
                ...
                for line in invoice.invoice_line :
                    ...
                    print "product_cost_price",product_cost_price
...
class account_invoice(models.Model):
    ...
    type_service = fields.Selection([('purchase_goods', 'Achat de marchandise'),('service', 'Service')],'Type de prestation',required=False,default='service')
