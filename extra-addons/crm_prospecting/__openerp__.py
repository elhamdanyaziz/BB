...

{
    ...
    'website': '',
    "version": "1.0",
    "depends": ['base','purchase_request','account_followup','crm','sale','sales_team','sale_crm','stock','sale_margin','sale_firm','account_voucher'],
    "author": "SMAPS",
    "category": "SALES",
    "description": """
        Ce module permet de :
    ...
    'update_xml': [
        ...
        'wizard/stock_removal_cancel_view.xml',
        'crm_sale_view.xml',
