...
class sale_order(models.Model):
    ...
    def action_create_removal_order(self):
        ...
        print "self.section_id.location_id",self.section_id.location_id.name,self.section_id.location_id.id
        print "self.section_id.id namee",self.section_id.id,self.section_id.name
        opp_id = False
        if self.opp_id :
