            ...
            if removal.state == 'draft':
                for line in self.line_ids:
                    if line.product_qty == line.move_id.product_uom_qty:
                        ...
                        # if line.product_qty <= line.move_id.sale_order_line_id.product_uom_qty - line.move_id.sale_order_line_id.qty_available:
                        #     line.move_id.sale_order_line_id.write({'qty_available': line.move_id.sale_order_line_id.qty_available + (line.product_qty - line.move_id.product_uom_qty)})
                        #     line.move_id.write({'product_uom_qty': line.product_qty})
                        # else:
