...
class stock_invoice_onshipping(models.TransientModel):
    ...
    def open_invoice(self):
        ...
        if picking.order_id:
            invoice.write({'order_id': picking.order_id.id,'with_deposit': picking.order_id.with_deposit,'deposit_number': picking.order_id.deposit_number,'with_guaranty': picking.order_id.with_guaranty,'guaranty_number': picking.order_id.guaranty_number})
