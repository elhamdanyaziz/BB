...
class account_invoice(models.Model):
    ...
    deposit_number_prc = fields.Char('Restitution d\'acompte',store=True, readonly=True, compute='_compute_amount', track_visibility='always')
    guaranty_number_prc = fields.Char('Pourcentage de la Remise',store=True, readonly=True, compute='_compute_amount', track_visibility='always')
    ...
    def action_move_create(self):
        ...
        for inv in self:
            ...
            print "account_invoice_tax.move_line_get(inv.id)",account_invoice_tax.move_line_get(inv.id)
