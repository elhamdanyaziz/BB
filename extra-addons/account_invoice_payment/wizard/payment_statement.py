    ...
    def create_payment_statement(self):
        ...
        if self.act_id == 'unpaid':
            for voucher in voucher_obj.browse(voucher_ids) :
                ...
                #desc = 'Retour '+'Impayé '.encode('utf-8')+'du '+'réglement de référence '.encode('utf-8')+'+ref+'+' de la banque '+voucher.bank_id.name
                desc = 'Retour Impayé du réglement de référence '+ref+' de la banque '+voucher.bank_id.name
                move_line_record = {
