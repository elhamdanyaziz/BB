...
#/#############################################################################
{
    ...
    'init_xml': [],
    'data': [
              'static/src/xml/deposit.xml',
              'views/layouts.xml',
              'views/account_voucher_view.xml',
              'views/account_journal_view.xml',
              'views/account_deposit_bank_view.xml',
              #'wizard/payment_view.xml',
              'wizard/bank_transfer_view.xml',
              'wizard/payment_statement_view.xml',
              'wizard/customer_situation_view.xml',
              'views/account_deposit_report.xml',
              'views/accountdepositlcn.xml',
              'views/accountdepositcheak.xml',
              'views/customer_situation.xml'
    ],
    'installable': True,
    'auto_install': True,
}
